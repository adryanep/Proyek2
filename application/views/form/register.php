            ...
            <div class="card-body login-card-body">
                ...
                <div class="form-group mb-0">
                    ...
                    <div class="radio-group">
                        <input type="radio" class="form_radio" value="member" name="role" id="member" required>
                        <label for="member" class="mb-0">
                            <div class="col-auto mx-1 card-block py-0 text-center radio">
                                <div class="flex-row">
                                    <div class="col">
                                        <div><img class="mt-3"
                                                src="https://i.postimg.cc/Prhp7W05/member-removebg-preview.png"
                        ...
                        <label for="admin" class="mb-0">
                            <div class="col-auto card-block py-0 text-center radio ">
                                <div class="flex-row">
                                    <div class="col">
                                        <div><img class="mt-3"
                                                src="https://i.postimg.cc/RFVK2cWt/admin-removebg-preview.png"
                                                width="100" height="100"></div>
                ...
                <b>
                    <p class="mb-0 text-right" style="color: red;">
                        sudah memiliki akun? <a href="<?= base_url() ?>login"
                            class="text-right  hvr-underline-from-center mb-1">Login Disini</a>
                    </p>
                </b>
            </div>
            <!-- /.card-body -->
